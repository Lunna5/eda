//! Based on https://github.com/theduke/ffprobe-rs
...
pub struct Stream {
    ...
    #[serde(default, with = "parse_float")]
...
impl Format {
    ...
    pub fn try_get_duration(
        &self,
    ) -> Option<Result<std::time::Duration, std::time::TryFromFloatSecsError>> {
        let duration_secs = self.duration?;
        Some(std::time::Duration::try_from_secs_f64(duration_secs))
    }
